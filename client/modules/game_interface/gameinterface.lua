...
function createThingMenu(menuPosition, lookThing, useThing, creatureThing)
  ...
  if creatureThing then
    ...
    if creatureThing:isNpc() then
      menu:addOption(tr('Talk'), function() g_game.talk('hi') end)
    end
...
function processMouseAction(menuPosition, mouseButton, autoWalkPos, lookThing, useThing, creatureThing, attackCreature)
  ...
  -- classic control
    ...
    if keyboardModifiers == KeyboardNoModifier and mouseButton == MouseRightButton and not g_mouse.isPressed(MouseLeftButton) then
      ...
      local targetNpc = (creatureThing and creatureThing:isNpc() and creatureThing) or (attackCreature and attackCreature:isNpc() and attackCreature)
      if targetNpc then
          g_game.talk('hi')
          return true
      end
